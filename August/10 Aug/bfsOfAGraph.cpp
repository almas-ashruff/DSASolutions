...
// BFS traversal of the graph starting from the 0th vertex,  from left to right according to the graph. 
...
// Also, if we want to include nodes that are not connected to the 0th node -
